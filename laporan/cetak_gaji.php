...
$peg2          = mysqli_query($koneksi,"SELECT * FROM pegawai ORDER BY id ASC");
...
ob_start();
?>
<title>Data Gaji Pegawai <?php echo $home['nama'];?></title>
...
<!--<br>
  <table width="100%">
    ...
    <td width="30%" style="font-size: 13px;" align="center">
      ...
      <br>
      <?php 
      $ttd=mysqli_query($koneksi,"SELECT * FROM pegawai WHERE jabatan='kepala bagian'");
...
$pdf->render();
$pdf->stream('Data Gaji Pegawai '.$home['nama'].'_'.$bln.'_'.$tahun.'.pdf', Array('Attachment'=>0));
?>
