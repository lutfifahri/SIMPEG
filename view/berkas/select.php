                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <!-- /.modal -->  
                                                <a href="download.php?foto=<?php echo $row_berkas['foto']; ?>" class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-placement="top" title="Download" > <i class="fa fa-download"></i> </a>
                                            </center> 
                                        </td>
                                    </tr>
